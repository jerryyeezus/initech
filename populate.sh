...
http -f POST "$host""register/" name="Jerry Yee" email="yee@gatech.edu" password="asdf" confirm_password="asdf" user_type="INSTRUCTOR" skills_str=""
...
http -f POST "$host""add_import/" import_csv@roster.csv pk=1

http -f POST "$host""add_courses/" course_name="Operating Systems" course_dept_and_id="CS 4210" course_professor="INSTRUCTOR|you@gatech.edu"
